// courses.js — Course List Array + dynamic rendering/filtering
// Toggle "completed" to true for any course you've finished.
const courses = [
    {
        subject: 'CSE',
        number: 110,
    ...
    courseList.forEach((course) => {
        ...
        card.innerHTML = `
            <div class="course-card-top">
                <span class="course-subject">${course.subject} ${course.number}</span>
                ${course.completed ? '<span class="completed-badge"><i class="fas fa-check-circle"></i> Completed</span>' : ''}
            </div>
            <h3>${course.title}</h3>
...
function filterCourses(subject) {
    ...
    document.querySelector(`.filter-btn[data-filter="${subject}"]`).classList.add('active');
}
